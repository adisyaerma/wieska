...
@section('isi')
    <div class="container-xxl container-p-y">
        ...
        <div class="row g-4">
            ...
            <!-- KANAN: Detail Gaji / Hutang -->
            <div class="col-lg-6 col-md-12">
                <div class="card shadow-sm h-100 border-0">
                    <div class="card-header bg-white border-bottom">
                        <h6 class="mb-0 text-dark fw-semibold">Detail Pembayaran Hutang</h6>
                    </div>
                    <div class="card-body p-3">
                        <table class="table table-sm table-borderless mb-0">
                            <tr>
                                <th>Pihak</th>
                                <td class="text-dark text-end">{{ $data->pihak }}</td>
                            </tr>
                            <tr>
                                <th>Total Hutang</th>
                                <td class="text-dark text-end">Rp {{ number_format($data->total_hutang, 0, ',', '.') }}</td>
                            </tr>
                            <tr>
                                <th>Dibayarkan</th>
                                <td class="text-dark fw-semibold text-end">Rp
                                    {{ number_format($data->nominal_pengeluaran, 0, ',', '.') }}
                                </td>
                            </tr>
                            <tr>
                                <th>Status Hutang</th>
                                <td>
                                    <span
                                        class="badge text-end {{ $data->status == 'Lunas' ? 'bg-success bg-opacity-25 text-success' : 'bg-secondary bg-opacity-25 text-secondary' }}">
