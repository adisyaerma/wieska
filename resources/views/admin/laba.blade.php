            ...
            <div class="table-responsive text-nowrap p-3">
                ...
                <table class="table" id="labaTable">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($laba as $i => $row)
                            <tr>
                                <td>{{ $i + 1 }}</td>
                                <td>{{ \Carbon\Carbon::parse($row->tanggal)->format('d-m-Y') }}</td>

                                <td>Rp {{ number_format($row->omzet_tiket, 0, ',', '.') }}</td>
                                <td>Rp {{ number_format($row->modal_tiket, 0, ',', '.') }}</td>

                                <td>Rp {{ number_format($row->omzet_cafe, 0, ',', '.') }}</td>
                                <td>Rp {{ number_format($row->modal_cafe, 0, ',', '.') }}</td>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="{{ route('laba.detail.tiket', $row->tanggal) }}">
                                                <i class="icon-base bx bx-receipt me-1"></i>
                                                Detail Tiket
                                            </a>

                                            <a class="dropdown-item" href="{{ route('laba.detail.cafe', $row->tanggal) }}">
